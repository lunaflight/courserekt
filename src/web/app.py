...
from src.history.api import INF, get_all_data, get_pdf_filepath, pdf_exists, get_latest_year_and_sem_with_coursereg_info
...
def history() -> str:
    ...
    (latestYear, latestSem) = get_latest_year_and_sem_with_coursereg_info()
